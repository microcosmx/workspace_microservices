...
public class AsyncTask {  
    ...
    public Future<Value> sendAsyncCal(HttpSession session, double cal2) throws InterruptedException{
		...
		ResponseEntity<Value> exchange = restTemplate.exchange("http://rest-service-3:16003/hello3?name=service-4&cal="+cal2, 
				HttpMethod.GET,new HttpEntity<Void>(headers), Value.class);
		Value value = exchange.getBody();
		
//    	Value value = restTemplate.getForObject("http://rest-service-3:16003/hello3?name=service-4&cal="+cal2, Value.class);
