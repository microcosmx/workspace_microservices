;; 
;; problem: add-1-rk611-bp
;; 
;; 
;; This problem requires PRODIGY to add 1 rk611 backplane (bp) to 
;; the order. 
;; 
;; 
...
(load-start-state '((order 1 rk611 mod)
...
(setq *generated-entities* (make-hash-table :test #'equal))
