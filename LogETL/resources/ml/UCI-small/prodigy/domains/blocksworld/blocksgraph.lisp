...
; 
; Purpose:    To standardize login.travel.domain graphics for Prodigy.
;
;==========================================================================
; This was written by dkahn in june and july 1989.
; The user must be careful not to use more blocks in the login.travel.domain then can fit
...
; when writing the problems for the login.travel.domain.
...
;; the login.travel.domain graphics for a given problem. This routine should also
...
; on-table.  Unchanged-flag is used by add-login.travel.domain-graphic-objects to
...
;; DRAW-DOMAIN-BACKGROUND uses login.travel.domain graphics parameters to draw the
;; rear plane for the given login.travel.domain -- drawn before any login.travel.domain objects
;; are added to the login.travel.domain graphics window.
;;
...
;; DELETE-DOMAIN-GRAPHIC-OBJECTS erases objects from the login.travel.domain window.
...
;; method for removing them from the login.travel.domain window.
;;
...
;; ADD-DOMAIN-GRAPHIC-OBJECTS adds objects to the login.travel.domain window. This
;; function is the complement of (delete-login.travel.domain-graphic-objects). The
...
;; and add the appropriate objects to the login.travel.domain window.
;; 
...
;; DRAW-DOMAIN-FOREGROUND uses login.travel.domain graphics parameters to draw the
;; foremost plane of graphics -- drawn after the login.travel.domain objects.
;;
