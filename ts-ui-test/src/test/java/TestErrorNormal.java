...
public class TestErrorNormal {
    ...
    public void testBooking() throws Exception{
        ...
        selTraintype.selectByValue("2"); //others
    ...
    public void testTicketPay ()throws Exception {
        ...
        System.out.println("The Alert information of pay Ticket："+statusPayAlert);
        Assert.assertEquals(!"".equals(statusPayAlert),true);
        if(itemTripId.startsWith("G")) {
            Assert.assertEquals(statusPayAlert.startsWith("Success"), true);
            System.out.println("Success to book，he train is "+itemTripId);
        }
        else{
            Assert.assertEquals(statusPayAlert.startsWith("Pay Fail"), true);
            System.out.println("Success to test the error-normal，the train is "+itemTripId);
        }
