...
public class TestFlowTwo {
    ...
    public void TestPayOrder() throws Exception{
        ...
        while(!(statusOrder.startsWith("Not Paid")) && i < myOrdersList.size()) {
        ...
        myOrdersList.get(i).findElement(By.xpath("/div[2]/div/div/form/div[7]/div/button")).click();
        Thread.sleep(1000);
    ...
    @Test (enabled = false,dependsOnMethods = {"TestViewOrders"})
    public void TestChangeOrder() throws Exception{
        System.out.printf("The orders list size is:%d%n",myOrdersList.size());
        String statusOrder  = "";
        int i = 0;
        //Find the first paid order .
        while(!(statusOrder.startsWith("Paid")) && i < myOrdersList.size()) {
            statusOrder = myOrdersList.get(i).findElement(By.xpath("/div[2]/div/div/form/div[7]/div/label[2]")).getText();
            i++;
        }
        if(i == myOrdersList.size() || i > myOrdersList.size())
        ...
        //click change btn
        myOrdersList.get(i).findElement(By.xpath("/div[2]/div/div/form/div[12]/div/button[1]")).click();
        Thread.sleep(1000);
